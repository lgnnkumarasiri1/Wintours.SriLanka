            ...
            {submitSuccess ? <div className="text-center py-8 animate-fadeIn">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  className="flex-1 bg-black hover:bg-gray-800 text-white py-2 px-4 rounded-md font-medium flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
