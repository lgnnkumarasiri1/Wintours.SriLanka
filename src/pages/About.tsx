...
const About = () => {
  return <div className="w-full pt-24 pb-16">
      ...
      <section className="relative py-20 bg-black text-white">
        ...
        backgroundImage: "url('https://uploadthingy.s3.us-west-1.amazonaws.com/9QFb355MKss6EdLzkFkrpT/dambulla.png')"
      }}></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-xl">
              Crafting unforgettable travel experiences since 2005. Our passion
              is connecting travelers with authentic experiences around the
              world.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              <img src="/colombo.png" alt="Our journey" className="rounded-lg shadow-lg w-full h-auto" />
            </div>
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 mb-4">
                ...
                cultural aspects, local food and beverages, as well as the daily
                lives of people.
              </p>
              <p className="text-gray-600">
                I look forward to designing the most attractive tailor-made tour
                packages based on the preferences of tourists and the number of
                days they stay in Sri Lanka.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              At TravelEase, our values guide everything we do. They reflect our
              commitment to our travelers and the communities we visit.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white bg-opacity-10 p-6 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-white text-opacity-90">
                Our team has extensive experience and firsthand knowledge of the
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/contact" className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-md font-medium transition-all">
              Contact Us
            </a>
            <a href="/packages" className="bg-white text-black hover:bg-gray-100 px-8 py-3 rounded-md font-medium transition-all">
              Explore Packages
            </a>
          </div>
        </div>
